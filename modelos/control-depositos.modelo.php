...
class ModeloCtrolDepositos
{
    ...
    LISTAR SALIDAS
    =============================================*/
    public static function mdlListarDepositos($tabla, $fechadev1, $fechadev2)
    {
        try {
            //$where='1=1';

            $where = 'DATE_FORMAT(cd.fecha_transaccion, "%Y-%m-%d")>="' . $fechadev1 . '" AND DATE_FORMAT(cd.fecha_transaccion, "%Y-%m-%d")<="' . $fechadev2 . '" ';
...
=============================================*/
    public static function mdlAjaxBeneficiario($tabla, $campo, $valor)
    {
        try {
...
=============================================*/
    public static function mdlDatosBeneficiario($tabla, $campo, $valor)
    {
        try {
            $estatus = 1;
...
=============================================*/
    public static function mdlGuardarDeposito($tabla, $datos)
    {
        try {
...
=============================================*/
    public static function mdlActualizarDeposito($tabla, $datos)
    {
        try {
...
=============================================*/
    public static function mdlGuardarCuentaHabiente($tabla, $datos)
    {
        try {
...
=============================================*/
    public static function mdlMostrarDestinatarios($tabla, $item, $valor)
    {
        try {
...
ELIMINAR DEPOSITO
=============================================*/
    public static function mdlBorrarDeposito($tabla, $idDep, $campo)
    {
        try {
...
TRAER DATOS DE BENEFICIARIO
=============================================*/
    public static function mdlDatosDeposito($tabla, $iddep, $campo)
    {
        try {
            $estatus = 1;
