...
try {         
    $sql="SELECT tb1.id, tb1.fechaentrada, tb1.id_proveedor,prov.nombre AS nombreproveedor, tb1.observacion, h.id_producto, h.cantidad, a.descripcion, a.codigointerno, a.id_medida, m.medida, tb1.id_almacen, b.nombre AS nombrealmacen,b.ubicacion, b.telefono AS tel_alm, b.email AS email_alm, tb1.id_tipomov, tm.nombre_tipo AS nombretipo, tb1.ultusuario, u.nombre AS nombreusuario 
    FROM $tabla tb1
