...
REGISTRO ORDEN DE SERVICIO
=============================================*/
    public static function mdlActualizarImagen($tabla, $firma, $id)
    {
...
=============================================*/
    public static function mdlActualizarTransito($tabla, $datos, $productos, $cantidades)
    {
        $cant = 0;
        //$entra=0;
        try {
...
=============================================*/
    public static function mdlListarOServicios($tabla, $item, $valor, $orden, $fechadev1, $fechadev2)
    {
        try {
...
/*===================================================================== */
    public static function MdlReporteExistenciaPorTecnico($tabla, $valor, $idalmacen, $idtecnico, $orden)
    {
        try {
...
=============================================*/
    public static function mdlObtenerOS($tabla, $campo, $valor)
    {
        try {
            if ($campo != null) {
...
=============================================*/
    public static function mdlObtenerMaterialOS($tabla, $campo, $valor)
    {
        try {
            if ($campo != null) {
...
/*==========================================================================================*/
    public static function mdlCambiarEstadoOS($tabla, $campo, $valor, $estado, $factura)
    {
        try {
            if ($campo != null) {
    ...
    public static function mdlGetDataOServicios($tabla, $campo, $valor, $status)
    {
        try {
			...
			WHERE os.$campo=:$campo";
                ...
                $sql = "SELECT `id`, `codigo`, `codigointerno`, `descripcion`, `conseries`, `estado` FROM `productos` WHERE estado=1 AND id IN ($valor) ORDER BY id ASC";
...
/************************************************************************************* */
    public static function mdlGetDataNumOS($tabla, $campo, $numos)
    {
...
/************************************************************************************* */
    public static function mdlTraerIdOs($tabla, $item, $valor)
    {
...
=============================================*/
    public static function mdlGuardarAgregaOS($tabla, $idregos, $fechaagrega, $nvaobservaos, $ultusuario)
    {
    ...
    =============================================*/
    public static function mdlGetMaterialOsFactura($tabla, $campo, $factura)
    {
        try {
            if ($campo != null) {
