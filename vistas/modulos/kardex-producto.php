...
ob_start();
$fechaIniK=date('Y-m-d', strtotime("-30 day"));
$fechaHoy=date("Y-m-d");
$tabla="usuarios";
$module="rkardex";
$campo="reportes";
...
.select2 {
 ...
 <!-- Content Wrapper. Contains page content -->
        ...
        <div class="card-header m-1 p-0">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-1.5">
              <input type="date" class="form-control form-control-sm bg-info" name="fechaIniKardex" id="fechaIniKardex" value="<?= $fechaIniK ?>" tabindex="3" title="Fecha Inicial">
            </div>

            <div class="form-group pl-1 col-md-1.5">
              <input type="date" class="form-control form-control-sm bg-primary" name="fechaFinKardex" id="fechaFinKardex" value="<?= $fechaHoy ?>" tabindex="3" title="Fecha Final">
            </div>

            <?php if(getAccess($acceso, ACCESS_PRINTER)){?>            
            <div class="form-group col-md-1">
              <button class="btn btn-success btn-sm" onclick="listarkardex()" ><i class="fa fa-eye"></i>  Mostrar</button>
            </div>
            <?php } ?>             
      </div>  
  ...
  <script defer src="vistas/js/kardex-producto.js?v=010920"></script> 
  <!-- /.content-wrapper 
