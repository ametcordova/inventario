...
$hoja->getStyle('E'. $fila . ':G'. $fila)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
...
$hoja->getColumnDimension('G')->setWidth(9);
$hoja->getColumnDimension('H')->setWidth(9);
