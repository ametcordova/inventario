...
-- Tiempo de generación: 03-11-2022 a las 19:41:19
...
CREATE TABLE `datosfacturatimbre` (
  ...
  `sellodigitalcfdi` text COLLATE utf8_spanish_ci,
  `sellodigitalsat` text COLLATE utf8_spanish_ci,
  `cadenaoriginal` text COLLATE utf8_spanish_ci,
  `codigoqr` text COLLATE utf8_spanish_ci,
...
(2, 1, 'A', 379, '2022-11-03 13:22:32', '00001000000515088380', '00001000000504204971', '', '', '||4.0|A|379|2022-11-03T13:20:31|99|00001000000515088380|NA|1105.00|MXN|1|1281.80|I|01|PPD|29027|DIGB980626MX3|BRUNO DIAZ GORDILLO|621|CIC991214L94|CARSO INFRAESTRUCTURA Y CONSTRUCCION|11529|623|I01|72151602|1|1|E48|Unidad de servicio|BAJANTE AEREO DE 200 M. FO-A 27102022/43 SUR1. PROY: CAR057061. ODC: 00072996. No. REPSE: 09679. CONTRATO: BAJSUR063-01|1105.000000|1105|02|1105|002|Tasa|0.160000|176.8|1105|002|Tasa|0.160000|176.80|176.80||', '', 5, '2022-11-03 13:22:33');
...
CREATE TABLE `facturaingreso` (
  ...
  `cfdirelacionados` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `conceptos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
(2, 1, 'A', 379, '635E4A0F-7483-417E-A9B4-0C1ECD204054', '2022-11-03 13:05:15', '2022-11-03 13:22:32', NULL, 'DIGB980626MX3', 621, 'I', 100, 29027, 01, 5, 4, 99, 'PPD', NULL, NULL, '[{\"ClaveProdServ\":\"72151602\",\"Cantidad\":\"1\",\"ClaveUnidad\":\"E48\",\"Unidad\":\"Unidad de servicio\",\"Descripcion\":\"BAJANTE AEREO DE 200 M. FO-A 27102022\\/43 SUR1. PROY: CAR057061. ODC:  00072996. No. REPSE: 09679. CONTRATO: BAJSUR063-01\",\"ValorUnitario\":\"1105.000000\",\"Importe\":\"1105\",\"ObjetoImp\":\"02\"}]', '', '1105.00', '16.00', '176.80', NULL, '1281.80', NULL, 5, '2022-11-03 23:17:05');
