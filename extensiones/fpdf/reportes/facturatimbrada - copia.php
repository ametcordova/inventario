...
$pdf->SetXY($x+155,$y);
$pdf->MultiCell(20,5, $row["ValorUnitario"], 'LTBR', 0, 'R', 1);

$pdf->SetXY($x+175,$y);
$pdf->MultiCell(21,5, $row["Importe"], 'LTBR', 0, 'R', 1);

if ($row != end($conceptos_json)) {     //si no es el Ùltimo elemento del array espaciado de 6.5
    $pdf->Ln(6.5);    
}
//break;
endforeach;
