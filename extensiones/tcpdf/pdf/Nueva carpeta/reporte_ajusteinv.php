...
$imagen=defined('IMAGEN')?'../../../'.IMAGEN:'../../../config/logotipo.png';
...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:68px"><img src="$imagen"></td>
			...
			<td style="background-color:white; width:110px; text-align:center; color:red"><br>AJUSTE INV. No.<br>$numdeajusteinv</td>
