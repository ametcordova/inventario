	...
	public function mostrarTablaProductosVentas(){
    	...
    	$orden = "id";
		  ...
		  for($i = 0; $i < count($productos); $i++){
		  	...
		  	$botones =  "<div class='btn-group'><button class='btn btn-primary btn-sm agregarProducto recuperarBoton' idProducto='".$productos[$i]["id"]."' title='Agregar'><i class='fa fa-plus-circle'</button></div>"; 
